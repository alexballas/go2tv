...
func lockFFmpegControls(screen *FyneScreen, tooltipWidget *widget.Label) {
	fyne.Do(func() {
...
func unlockFFmpegControls(screen *FyneScreen, tooltipWidget *widget.Label) {
	fyne.Do(func() {
...
func setTranscodeForDeviceType(screen *FyneScreen, deviceType string, tooltipWidget *widget.Label) {
	...
	case devices.DeviceTypeChromecast:
		...
		lockFFmpegControls(screen, tooltipWidget)
	...
	case devices.DeviceTypeDLNA:
		...
		screen.TranscodeCheckBox.Refresh()
		unlockFFmpegControls(screen, tooltipWidget)
